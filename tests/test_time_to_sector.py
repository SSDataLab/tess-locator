...
from tess_locator.wcs_catalog import time_to_sector
...
def test_time_to_sector():
    ...
    assert_array_equal(time_to_sector(["2018-06-01", "2019-06-01", "2020-06-01"]), [-1, 12, 25])
    assert_array_equal(time_to_sector(Time(["2018-06-01", "2019-06-01", "2020-06-01"])), [-1, 12, 25])
